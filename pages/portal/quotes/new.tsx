...
export default function NewQuotePage() {
  ...
  const { status: accessStatus } = usePortalAccess();
    ...
    <PortalShell title="New Quote">
      <main className="max-w-4xl mx-auto px-4 sm:px-6 py-10">
        ...
        {accessStatus === "no-access" && (
          <m.div {...fade()}>
            <div className="rounded-2xl border border-gi-line bg-white shadow-gi p-8 max-w-md mx-auto text-center">
              ...
              <p className="text-sm text-gi-navy/60 mb-6">
                Contact your Green Irony representative to request access.
              </p>
        ...
        {(accessStatus === "ok" || accessStatus === "error") && (
                    ...
                    {files.length > 0 ? (
                      ...
                      <>
                        ...
                        <p className="text-sm text-gi-navy/50">
                          Have call recordings or transcripts? Drop them here
