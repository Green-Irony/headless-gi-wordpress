    ...
    <>
      ...
      <main>
        ...
        <ValuePillars
          ...
          subhead="Deliver Salesforce the right way — AI-accelerated discovery, design, and build that go live in as little as 4 weeks, drive adoption on day one, and avoid costly rework."
          items={[
